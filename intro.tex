...
- make comparison of the performance of the different models. 
...
Have to add a chapter by chapter overview. Reader should have an idea how the thesis is structured.
 ...
 Two three lines explaination structure. Very important.  This chapter is organized as follows … (can always be the same)
