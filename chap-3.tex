...
- note that gradient norm clipping is used as explained in ... --> it was seen that the nan values in the prediction were because of a too big learning rate of 0.1 --> smaller learning rates didn't give a problem. 
...
\begin{table}[ht]
	...
	\begin{tabular}{@{}l|ccc@{}} \toprule
		...
		Units LSTM & $0.950 $&$ 0.8298 $  & $0.8224 $\\
		layers LSTM & $0.8377 $&$ 0.7771 $  & $0.7363$\\
		Lag value & $0.9084 $&$ 0.8621$  & $0.8426$\\
		Learning rate & $0.9084 $&$ 0.8621$  & $0.8426$\\\bottomrule
	\end{tabular}
	\caption{The best parameters for the three different series after phase $ 1 $ of the parameter search}
	\label{tab:summ_data_rel_performance}
\end{table}
