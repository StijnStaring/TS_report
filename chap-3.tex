...
\begin{table}[ht]
	...
	\label{tab:relative_performance_parameters_phase_one}
\end{table}
...
\begin{table}[ht]
	...
	\end{tabular}
	\caption{The varied parameters with their values that performed best for the three time series after phase $ 1 $ of the parameter search.}
