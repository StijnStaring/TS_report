...
In this section more LSTM and GRU models, that are specialized in time series learning, are presented in different variations. The inputs to theses models are given by Table \ref{tab:inputs}.


These models are implemented so that they sequentially predict each half hour of consumption, taking into account the previous   
