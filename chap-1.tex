...
In order to look at the impact of a holiday all the holidays all the holidays of the English and welsh holiday calendar are identified for the year $ 2017 $. For each of the $ 8 $ holidays a corresponding business is selected with an as close as possible average temperature of the day. This is done to remove the temperature dependency.
